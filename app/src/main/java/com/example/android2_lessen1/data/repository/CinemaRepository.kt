...
class CinemaRepository {
    private var catList = arrayListOf<CatsModels>()

    fun getListOfText(): MutableList<CatsModels> {
        catList.clear()
        catList.add(
            CatsModels(
                "02", "https://thumbs.dfs.ivi.ru/storage2/contents/6/0/e926217" +
                        "deefe93b26e6150939c0330.jpg/234x360/?q=60"
            )
        )
        catList.add(
            CatsModels(
        ...
        catList.add(CatsModels("02.2", "https://b1.filmpro.ru/c/812189.246x347.jpg"))
        catList.add(
            CatsModels(
                "02.3",
        ...
        catList.add(
            CatsModels(
                "02.6", "https://ms1.relax.by/images/d4b21593f3f04b3b118e37d5e68927ff/thumb/" +
                        "w%3D400%2Ch%3D600%2Cq%3D90/afisha_event_photo/de/eb/95/deeb95794d2e9aa1fce6c1dadbc34270.jpg"
            )
        )
        catList.add(
            CatsModels(
        ...
        catList.add(CatsModels("02.9", "https://www.kino-teatr.ru/movie/posters/big/1/146951.jpg"))
        catList.add(
            CatsModels(
                "02.10",
        ...
        catList.add(CatsModels("02.13", "https://images.kinomax.ru/550/films/6/6576/p_ceaf2ca.jpg"))
        catList.add(
            CatsModels(
                "02.14",
